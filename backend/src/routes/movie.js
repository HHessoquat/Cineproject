...
const { getAllMovies, getOneMovie, getOnlineMovies, getMovieByTitle, getEventMovie } = require('../controllers/movie/getMovies.js');
...
router.get('/byTitle/:title', getMovieByTitle);
router.get('/event/:event', getEventMovie);
