...
function Movie() {
    ...
    return (
        <main>
            ...
            {isReservationOpen && (
            <div className="modalContainer" onClick={handleReservationClick}>
                ...
                <section id="movie_info">
                    ...
                    <main id="movieDetail">
                        ...
                        <ul>
                            ...
                            <span className="movieFeature">{movie.warning}</span></li>
                            }
                    ...
                    <aside >
                        ...
                        {!groupedSessions && <p>Il n'y a pas encore de séances pour ce film</p>}
